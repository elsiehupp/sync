...
public class OwncloudDolphinPluginHelper : GLib.Object {
    ...
    ***********************************************************/
    ...
    protected GLib.Vector<string> paths;
    ...
    ***********************************************************/
    ...
    /***********************************************************
    ***********************************************************/
    public GLib.Vector<string> paths () {
        return this.paths;
    }
    ...
    ***********************************************************/
    ...
    /***********************************************************
    ***********************************************************/
    protected void on_signal_connected ();
    void OwncloudDolphinPluginHelper.on_signal_connected () {
