...
class PropagateRemoteDeleteEncryptedRootFolder : AbstractPropagateRemoteDeleteEncrypted {
    ...
    ***********************************************************/
    ...
    /***********************************************************
    ***********************************************************/
    private void on_folder_unlocked_successfully (GLib.ByteArray folder_identifier) {
    ...
    ***********************************************************/
    private void delete_nested_remote_item (string filename) {
        ...
        connect (delete_job, &DeleteJob.finished_signal, this, &PropagateRemoteDeleteEncryptedRootFolder.on_delete_nested_remote_item_finished);
