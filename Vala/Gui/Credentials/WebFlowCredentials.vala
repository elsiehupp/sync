...
public class WebFlowCredentials : LibSync.AbstractCredentials {
    ...
    //  private GLib.Queue<GLib.TlsCertificate> client_ssl_ca_certificates_write_queue;
    ...
    //  protected GLib.List<GLib.TlsCertificate> client_ssl_ca_certificates;
    ...
    //  public WebFlowCredentials (
        //  string user,
        //  string password,
        //  GLib.TlsCertificate certificate = GLib.TlsCertificate (),
        //  GLib.ByteArray key = GLib.ByteArray (),
        //  GLib.List<GLib.TlsCertificate> ca_certificates = new GLib.List<GLib.TlsCertificate> ()) {
        //  this.user = user;
