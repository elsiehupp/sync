...
public class ShareUserLine { //: Gtk.Widget {
    ...
    ***********************************************************/
    public ShareUserLine (
        ...
        //  // adds permissions
        //  // can edit permission
        //  bool enabled = max_sharing_permissions & SharePermission.UPDATE;
        //  if (!this.is_file) {
        //      enabled = enabled && (
        //          max_sharing_permissions & SharePermission.CREATE
        //          && max_sharing_permissions & SharePermission.DELETE);
        //  }
        ...
        //  this.permission_reshare.enabled = max_sharing_permissions & SharePermission.SHARE;
        ...
        //      this.permission_create.enabled = max_sharing_permissions & SharePermission.CREATE;
        ...
        //      this.permission_change.enabled max_sharing_permissions & SharePermission.UPDATE;
        ...
        //      this.permission_delete.enabled = max_sharing_permissions & SharePermission.DELETE;
    ...
    ***********************************************************/
    private void on_signal_permissions_changed () {
        ...
        //      permissions |= SharePermission.SHARE;

        //  if (!this.is_file) {
        //      if (this.permission_change.is_checked ()) {
        //          permissions |= SharePermission.UPDATE;
        //      }
        //      if (this.permission_create.is_checked ()) {
        //          permissions |= SharePermission.CREATE;
        //      }
        //      if (this.permission_delete.is_checked ()) {
        //          permissions |= SharePermission.DELETE;
        //      }
        //  } else {
    ...
    ***********************************************************/
    private void display_permissions () {
        ...
        //  //  folders edit = CREATE, READ, UPDATE, DELETE
        //  //  files edit = READ + UPDATE
        //  if (perm & SharePermission.UPDATE
        //      && (
        //          this.is_file || (
        //              perm & SharePermission.CREATE && perm & SharePermission.DELETE)
        //          )
        //      ) {
        //      this.instance.permissions_edit.check_state (GLib.Checked);
        //  } else if (!this.is_file && perm & (SharePermission.UPDATE | SharePermission.CREATE | SharePermission.DELETE)) {
        //      this.instance.permissions_edit.check_state (GLib.PartiallyChecked);
        //  } else if (perm & SharePermission.READ) {
        //      this.instance.permissions_edit.check_state (GLib.Unchecked);
        //  }

        //  // Edit is independent of reshare
        //  if (perm & SharePermission.SHARE) {
        //      this.permission_reshare.checked (true);
        //  }

        //  if (!this.is_file) {
        //      this.permission_create.checked (perm & SharePermission.CREATE);
        //      this.permission_change.checked (perm & SharePermission.UPDATE);
        //      this.permission_delete.checked (perm & SharePermission.DELETE);
        //  }
    }
    ...
    ***********************************************************/
    ...
    /***********************************************************
    ***********************************************************/
    private void show_expire_date_options (
        bool show,
        GLib.Date initial_date = GLib.Date ()
    ) {
