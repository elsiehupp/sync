...
public class SslErrorDialog { //: Gtk.Dialog {
    ...
    //  /***********************************************************
    //  ***********************************************************/
    //  GLib.List<GLib.TlsCertificate> unknown_certificates { public get; private set; }
    ...
    //  public bool check_failing_certificates_known (GLib.List<GLib.SslError> errors) {
        ...
        //  GLib.List<GLib.TlsCertificate> trusted_certificates = this.account.approved_certificates ();
        ...
        //  foreach (GLib.TlsCertificate cert in this.unknown_certificates) {
    ...
    //  /***********************************************************
    //  ***********************************************************/
    //  private string cert_div (GLib.TlsCertificate cert) {
        //  string message;
        //  message += GLib.L ("<div identifier=\"cert\">");
        //  message += GLib.L ("<h3>") + _("with Certificate %1").printf (Utility.escape (cert.subject_info (GLib.TlsCertificate.Common_name))) + GLib.L ("</h3>");

        //  message += GLib.L ("<div identifier=\"ccert\">");
        //  GLib.List<string> li;

        //  string org = Utility.escape (cert.subject_info (GLib.TlsCertificate.Organization));
        //  string unit = Utility.escape (cert.subject_info (GLib.TlsCertificate.Organizational_unit_name));
        //  string country = Utility.escape (cert.subject_info (GLib.TlsCertificate.Country_name));
        //  if (unit == "") {
        ...
        //  message += GLib.L ("<h3>") + _("Issuer : %1").printf (Utility.escape (cert.issuer_info (GLib.TlsCertificate.Common_name))) + GLib.L ("</h3>");
        //  message += GLib.L ("<div identifier=\"issuer\">");
        //  li = "";
        //  li += _("Organization : %1").printf (Utility.escape (cert.issuer_info (GLib.TlsCertificate.Organization)));
        //  li += _("Unit : %1").printf (Utility.escape (cert.issuer_info (GLib.TlsCertificate.Organizational_unit_name)));
        //  li += _("Country : %1").printf (Utility.escape (cert.issuer_info (GLib.TlsCertificate.Country_name)));
        //  message += GLib.L ("<p>") + li.join (GLib.L ("<br/>")) + GLib.L ("</p>");
        //  message += GLib.L ("</div>");
        //  message += GLib.L ("</div>");
