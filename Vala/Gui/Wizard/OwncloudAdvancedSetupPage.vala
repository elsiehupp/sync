...
signals:
    ...
    /***********************************************************
    ***********************************************************/
    public void on_error_string (string );
    ...
    ***********************************************************/
    ...
    /***********************************************************
    ***********************************************************/
    private void radio_checked (QRadio_button radio);
    ...
    ***********************************************************/
    ...
    void Owncloud_advanced_setup_page.user_information () {
        const var account = this.oc_wizard.account ();
    ...
    void Owncloud_advanced_setup_page.server_address_label_url (GLib.Uri url) {
        if (!url.is_valid ()) {
            return;
        }
    ...
    void Owncloud_advanced_setup_page.resolution_gui_visible (bool value) {
    ...
    void Owncloud_advanced_setup_page.on_error_string (string err) {
        if (err.is_empty ()) {
    ...
    void Owncloud_advanced_setup_page.on_remote_folder (string remote_folder) {
    ...
    void Owncloud_advanced_setup_page.local_folder_push_button_path (string path) {
    ...
    void Owncloud_advanced_setup_page.radio_checked (QRadio_button radio) {
