...
public class FolderStatusDelegate { //: GLib.StyledItemDelegate {
    ...
    ***********************************************************/
    ...
    /***********************************************************
    ***********************************************************/
    public bool editor_event (
        Gdk.Event event,
        GLib.AbstractItemModel model,
        GLib.StyleOptionViewItem option,
    ...
    ***********************************************************/
    public static GLib.Rect options_button_rect (
        GLib.Rect within,
        GLib.LayoutDirection direction
    ) {
    ...
    /***********************************************************
    ***********************************************************/
    public static GLib.Rect add_button_rect (GLib.Rect within, GLib.LayoutDirection direction) {
        //  Cairo.FontOptions font_options = new Cairo.FontOptions (GLib.Application.font ("GLib.PushButton"));
