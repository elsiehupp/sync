...
class Profile_page_menu : Gtk.Widget {
    ...
    ***********************************************************/
    ...
    void Profile_page_menu.on_hovercard_fetched () {
        ...
        const var hovercard_actions = this.profile_connector.hovercard ()._actions;
        for (var hovercard_action : hovercard_actions) {
            const var action = this.menu.add_action (hovercard_action._icon, hovercard_action._title);
