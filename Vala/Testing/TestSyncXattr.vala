...
public class TestSyncXAttr : GLib.Object {
    ...
    ***********************************************************/
    private void on_signal_test_virtual_file_lifecycle () {
        ...
        GLib.assert_cmp (database_record (fake_folder, "A/a1").file_size, 64);
        ...
        GLib.assert_cmp (database_record (fake_folder, "A/a1m").file_size, 65);
        ...
        GLib.assert_cmp (database_record (fake_folder, "A/a2").file_size, 32);
        XAVERIFY_VIRTUAL (fake_folder, "A/a3");
        GLib.assert_cmp (database_record (fake_folder, "A/a3").file_size, 33);
        on_signal_cleanup ();
    ...
    ***********************************************************/
    private void on_signal_test_virtual_file_conflict () {
        ...
        GLib.assert_cmp (database_record (fake_folder, "A/a1").file_size, 11);
        GLib.assert_cmp (database_record (fake_folder, "A/a2").file_size, 12);
        GLib.assert_cmp (database_record (fake_folder, "B/b1").file_size, 21);
        on_signal_cleanup ();
    ...
    ***********************************************************/
    private void on_signal_test_with_normal_sync () {
        ...
        GLib.assert_cmp (database_record (fake_folder, "A/new").file_size, 42);
