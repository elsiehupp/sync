...
public class TestMoveFailsInAConflict { //: GLib.Object {
    ...
    //      // restore permissions
    //      new GLib.File (fake_folder.local_path + "A/").set_permissions (GLib.FileAttributeInfoList (0x7777));
    ...
    //          new GLib.File (fake_folder.local_path + "A/").set_permissions (GLib.FileAttributeInfoList (0x5555));
    //      }
    //  }
