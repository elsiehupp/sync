...
public abstract class AbstractTestCSyncExclude : GLib.Object {
    ...
    ***********************************************************/
    protected static ExcludedFiles excluded_files;
    ...
    ***********************************************************/
    protected static void up () {
        excluded_files = new ExcludedFiles ();
        excluded_files.set_wildcards_match_slash (false);
    }

    /***********************************************************
    ***********************************************************/
    protected static ExcludedFiles check_file_full (string path) {
        return excluded_files.full_pattern_match (path, ItemType.FILE);
    }

    /***********************************************************
    ***********************************************************/
    protected static ExcludedFiles check_dir_full (string path) {
        return excluded_files.full_pattern_match (path, ItemType.DIRECTORY);
    }

    /***********************************************************
    ***********************************************************/
    protected static ExcludedFiles check_file_traversal (string path) {
        return excluded_files.traversal_pattern_match (path, ItemType.FILE);
    }

    /***********************************************************
    ***********************************************************/
    protected static ExcludedFiles check_dir_traversal (string path) {
