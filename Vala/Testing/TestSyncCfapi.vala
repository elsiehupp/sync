...
const int CFVERIFY_VIRTUAL (folder, path)
    ...
    GLib.assert_cmp (database_record ( (folder), (path)).type, ItemType.VIRTUAL_FILE);

const int CFVERIFY_NONVIRTUAL (folder, path)
    GLib.assert_true (GLib.FileInfo ( (folder).local_path () + (path)).exists ());
    GLib.assert_true (!cfapi.is_sparse_file ( (folder).local_path () + (path)));
    GLib.assert_true (database_record ( (folder), (path)).is_valid ());
    GLib.assert_cmp (database_record ( (folder), (path)).type, ItemType.FILE);
...
public class TestSyncCfApi : GLib.Object {
    ...
    ***********************************************************/
    private void on_signal_test_virtual_file_lifecycle () {
        ...
        CFVERIFY_VIRTUAL (fake_folder, "A/a3");
    ...
    ***********************************************************/
    private void on_signal_test_virtual_file_conflict () {
        ...
        CFVERIFY_VIRTUAL (fake_folder, "A/a1");
        CFVERIFY_VIRTUAL (fake_folder, "A/a2");
        CFVERIFY_VIRTUAL (fake_folder, "B/b1");
        GLib.assert_cmp (GLib.FileInfo (fake_folder.local_path () + "A/a1").size (), 11);
        GLib.assert_cmp (GLib.FileInfo (fake_folder.local_path () + "A/a2").size (), 12);
        GLib.assert_cmp (GLib.FileInfo (fake_folder.local_path () + "B/b1").size (), 21);
        on_signal_cleanup ();
        ...
        CFVERIFY_NONVIRTUAL (fake_folder, "B/b1");
    ...
    ***********************************************************/
    private void on_signal_test_virtual_file_download () {
        ...
        CFVERIFY_VIRTUAL (fake_folder, "A/a2");
        CFVERIFY_VIRTUAL (fake_folder, "A/a3");
        CFVERIFY_VIRTUAL (fake_folder, "A/a4");
        CFVERIFY_VIRTUAL (fake_folder, "A/a5");
        CFVERIFY_VIRTUAL (fake_folder, "A/a6");
        CFVERIFY_VIRTUAL (fake_folder, "A/a7");
        CFVERIFY_VIRTUAL (fake_folder, "A/b1");
        CFVERIFY_VIRTUAL (fake_folder, "A/b2");
        CFVERIFY_VIRTUAL (fake_folder, "A/b3");
        CFVERIFY_VIRTUAL (fake_folder, "A/b4");
        ...
        CFVERIFY_NONVIRTUAL (fake_folder, "A/a4m");
        CFVERIFY_NONVIRTUAL (fake_folder, "A/a5");
        CFVERIFY_NONVIRTUAL (fake_folder, "A/a6");
        CFVERIFY_NONVIRTUAL (fake_folder, "A/a7");
        CFVERIFY_NONVIRTUAL (fake_folder, "A/b1");
        CFVERIFY_NONVIRTUAL (fake_folder, "A/b2");
        CFVERIFY_GONE (fake_folder, "A/b3");
        CFVERIFY_GONE (fake_folder, "A/b4");
        CFVERIFY_NONVIRTUAL (fake_folder, "A/b4m");
    ...
    ***********************************************************/
    private void on_signal_test_virtual_file_download_resume () {
        ...
        GLib.assert_true (GLib.FileInfo (fake_folder.local_path () + "A/a1").exists ());
        GLib.assert_cmp (database_record (fake_folder, "A/a1").type, ItemType.VIRTUAL_FILE_DOWNLOAD);
        on_signal_cleanup ();
    ...
    ***********************************************************/
    private void on_signal_test_download_recursive () {
        ...
        CFVERIFY_VIRTUAL (fake_folder, "A/a1");
        CFVERIFY_VIRTUAL (fake_folder, "A/a2");
        CFVERIFY_VIRTUAL (fake_folder, "A/Sub/a3");
        CFVERIFY_VIRTUAL (fake_folder, "A/Sub/a4");
        CFVERIFY_VIRTUAL (fake_folder, "A/Sub/SubSub/a5");
        CFVERIFY_VIRTUAL (fake_folder, "A/Sub2/a6");
        CFVERIFY_VIRTUAL (fake_folder, "B/b1");
        ...
        CFVERIFY_VIRTUAL (fake_folder, "A/a1");
        CFVERIFY_VIRTUAL (fake_folder, "A/a2");
        CFVERIFY_NONVIRTUAL (fake_folder, "A/Sub/a3");
        CFVERIFY_NONVIRTUAL (fake_folder, "A/Sub/a4");
        CFVERIFY_NONVIRTUAL (fake_folder, "A/Sub/SubSub/a5");
        CFVERIFY_VIRTUAL (fake_folder, "A/Sub2/a6");
        CFVERIFY_VIRTUAL (fake_folder, "B/b1");
        CFVERIFY_VIRTUAL (fake_folder, "B/Sub/b2");
        ...
        CFVERIFY_NONVIRTUAL (fake_folder, "A/Sub/a4");
        CFVERIFY_NONVIRTUAL (fake_folder, "A/Sub/SubSub/a5");
        CFVERIFY_NONVIRTUAL (fake_folder, "A/Sub/SubSub/a7");
        CFVERIFY_NONVIRTUAL (fake_folder, "A/Sub2/a6");
        CFVERIFY_VIRTUAL (fake_folder, "B/b1");
        CFVERIFY_VIRTUAL (fake_folder, "B/Sub/b2");
    ...
    ***********************************************************/
    private void on_signal_test_rename_virtual () {
        ...
        CFVERIFY_VIRTUAL (fake_folder, "file1");
        CFVERIFY_VIRTUAL (fake_folder, "file2");
        CFVERIFY_VIRTUAL (fake_folder, "file3");
    ...
    ***********************************************************/
    private void on_signal_test_rename_virtual2 () {
        ...
        CFVERIFY_NONVIRTUAL (fake_folder, "case4");
    ...
    private void on_signal_test_sync_dehydration () {
        ...
        GLib.assert_true (item_instruction (complete_spy, "A/a1", SyncInstructions.SYNC));
        GLib.assert_cmp (complete_spy.find_item ("A/a1").type, ItemType.VIRTUAL_FILE_DEHYDRATION);
        ...
        GLib.assert_true (item_instruction (complete_spy, "A/a2", SyncInstructions.SYNC));
        GLib.assert_cmp (complete_spy.find_item ("A/a2").type, ItemType.VIRTUAL_FILE_DEHYDRATION);
    ...
    ***********************************************************/
    private void on_signal_test_wipe_virtual_suffix_files () {
        ...
        CFVERIFY_VIRTUAL (fake_folder, "f1");
        CFVERIFY_VIRTUAL (fake_folder, "A/a1");
        CFVERIFY_VIRTUAL (fake_folder, "A/a3");
        CFVERIFY_VIRTUAL (fake_folder, "A/B/b1");
    ...
    ***********************************************************/
    private void on_signal_test_new_virtuals () {
        ...
        CFVERIFY_VIRTUAL (fake_folder, "file1");
        CFVERIFY_VIRTUAL (fake_folder, "online/file1");
        ...
        CFVERIFY_NONVIRTUAL (fake_folder, "file2");
        CFVERIFY_VIRTUAL (fake_folder, "online/file2");
        CFVERIFY_NONVIRTUAL (fake_folder, "local/file2");
        CFVERIFY_VIRTUAL (fake_folder, "unspec/file2");

        // root file1 was hydrated due to its new pin state
        CFVERIFY_NONVIRTUAL (fake_folder, "file1");
        ...
        CFVERIFY_VIRTUAL (fake_folder, "file3");
        CFVERIFY_VIRTUAL (fake_folder, "online/file3");
        CFVERIFY_NONVIRTUAL (fake_folder, "local/file3");
        CFVERIFY_VIRTUAL (fake_folder, "unspec/file3");
