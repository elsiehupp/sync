...
public class TestClearAtClearAtTimestamp2 : GLib.Object {

    private TestClearAtClearAtTimestamp2 (GLib.DateTime current_time) {
...
} // class TestClearAtClearAtTimestamp2
