...
public class TestClearAtClearAtTimestamp3 { //: GLib.Object {

    private TestClearAtClearAtTimestamp3 (GLib.DateTime current_time) {
...
} // class TestClearAtClearAtTimestamp3
