...
public class TestClearAtClearAtTimestamp6 : GLib.Object {

    private TestClearAtClearAtTimestamp6 (GLib.DateTime current_time) {
...
} // class TestClearAtClearAtTimestamp6
