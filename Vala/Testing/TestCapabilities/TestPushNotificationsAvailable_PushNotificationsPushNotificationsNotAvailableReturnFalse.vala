...
public class TestPushNotificationsAvailable_PushNotificationsPushNotificationsNotAvailableReturnFalse { //: GLib.Object {

    //  /***********************************************************
    //  ***********************************************************/
    //  private TestPushNotificationsAvailable_PushNotificationsPushNotificationsNotAvailableReturnFalse () {
    //      var capabilities = Capabilities (GLib.HashMap ());
...
} // class TestPushNotificationsAvailable_PushNotificationsPushNotificationsNotAvailableReturnFalse
