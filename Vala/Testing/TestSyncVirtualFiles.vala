...
class TestSyncVirtualFiles : GLib.Object {
    ...
    ***********************************************************/
    private void on_signal_test_virtual_file_lifecycle () {
        ...
        GLib.assert_cmp (GLib.FileInfo (fake_folder.local_path () + "A/a1" DVSUFFIX).last_modified (), someDate);
        GLib.assert_true (fake_folder.current_remote_state ().find ("A/a1"));
        GLib.assert_true (itemInstruction (complete_spy, "A/a1" DVSUFFIX, CSYNC_INSTRUCTION_NEW));
        GLib.assert_cmp (dbRecord (fake_folder, "A/a1" DVSUFFIX).type, ItemTypeVirtualFile);
        on_signal_cleanup ();
        ...
        GLib.assert_true (fake_folder.current_local_state ().find ("A/a1" DVSUFFIX));
        GLib.assert_true (fake_folder.current_remote_state ().find ("A/a1"));
        GLib.assert_true (itemInstruction (complete_spy, "A/a1" DVSUFFIX, CSYNC_INSTRUCTION_UPDATE_METADATA));
        GLib.assert_cmp (dbRecord (fake_folder, "A/a1" DVSUFFIX).type, ItemTypeVirtualFile);
        GLib.assert_cmp (dbRecord (fake_folder, "A/a1" DVSUFFIX).file_size, 65);
        on_signal_cleanup ();
        ...
        GLib.assert_true (
            itemInstruction (complete_spy, "A/a1m" DVSUFFIX, CSYNC_INSTRUCTION_RENAME)
            || (itemInstruction (complete_spy, "A/a1m" DVSUFFIX, CSYNC_INSTRUCTION_NEW)
                && itemInstruction (complete_spy, "A/a1" DVSUFFIX, CSYNC_INSTRUCTION_REMOVE)));
        GLib.assert_cmp (dbRecord (fake_folder, "A/a1m" DVSUFFIX).type, ItemTypeVirtualFile);
        on_signal_cleanup ();
        ...
        GLib.assert_true (!fake_folder.current_local_state ().find ("A/a1m" DVSUFFIX));
        GLib.assert_true (!fake_folder.current_remote_state ().find ("A/a1m"));
        GLib.assert_true (itemInstruction (complete_spy, "A/a1m" DVSUFFIX, CSYNC_INSTRUCTION_REMOVE));
        GLib.assert_true (!dbRecord (fake_folder, "A/a1" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "A/a1m" DVSUFFIX).is_valid ());
        on_signal_cleanup ();
        ...
        GLib.assert_true (fake_folder.sync_once ());
        GLib.assert_true (fake_folder.current_local_state ().find ("A/a2" DVSUFFIX));
        GLib.assert_true (itemInstruction (complete_spy, "A/a2" DVSUFFIX, CSYNC_INSTRUCTION_UPDATE_METADATA));
        GLib.assert_true (dbRecord (fake_folder, "A/a2" DVSUFFIX).is_valid ());
        GLib.assert_true (!fake_folder.current_local_state ().find ("A/a3" DVSUFFIX));
        GLib.assert_true (itemInstruction (complete_spy, "A/a3" DVSUFFIX, CSYNC_INSTRUCTION_REMOVE));
        GLib.assert_true (!dbRecord (fake_folder, "A/a3" DVSUFFIX).is_valid ());
        on_signal_cleanup ();
    }
    ...
    ***********************************************************/
    private void on_signal_test_virtual_file_conflict () {
        ...
        GLib.assert_true (itemInstruction (complete_spy, "B/b2", CSYNC_INSTRUCTION_CONFLICT));
        GLib.assert_true (itemInstruction (complete_spy, "C/c1", CSYNC_INSTRUCTION_CONFLICT));
        ...
        GLib.assert_cmp (fake_folder.sync_journal ().conflictRecordPaths ().size (), 3);

        // nothing should have the virtual file tag
        GLib.assert_cmp (dbRecord (fake_folder, "A/a1").type, ItemTypeFile);
        GLib.assert_cmp (dbRecord (fake_folder, "A/a2").type, ItemTypeFile);
        GLib.assert_cmp (dbRecord (fake_folder, "B/b1").type, ItemTypeFile);
        GLib.assert_cmp (dbRecord (fake_folder, "B/b2").type, ItemTypeFile);
        GLib.assert_cmp (dbRecord (fake_folder, "C/c1").type, ItemTypeFile);
        GLib.assert_true (!dbRecord (fake_folder, "A/a1" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "A/a2" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "B/b1" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "B/b2" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "C/c1" DVSUFFIX).is_valid ());
    ...
    ***********************************************************/
    private void on_signal_test_with_normal_sync () {
        ...
        GLib.assert_true (itemInstruction (complete_spy, "A/new" DVSUFFIX, CSYNC_INSTRUCTION_NEW));
        GLib.assert_cmp (dbRecord (fake_folder, "A/new" DVSUFFIX).type, ItemTypeVirtualFile);
        on_signal_cleanup ();
    }
    ...
    ***********************************************************/
    private void on_signal_test_virtual_file_download () {
        ...
        GLib.assert_true (itemInstruction (complete_spy, "A/a1" DVSUFFIX, CSYNC_INSTRUCTION_NONE));
        ...
        GLib.assert_true (itemInstruction (complete_spy, "A/a2" DVSUFFIX, CSYNC_INSTRUCTION_NONE));
        GLib.assert_true (itemInstruction (complete_spy, "A/a3" DVSUFFIX, CSYNC_INSTRUCTION_REMOVE));
        GLib.assert_true (itemInstruction (complete_spy, "A/a4m", CSYNC_INSTRUCTION_NEW));
        GLib.assert_true (itemInstruction (complete_spy, "A/a4" DVSUFFIX, CSYNC_INSTRUCTION_REMOVE));
        GLib.assert_true (itemInstruction (complete_spy, "A/a5", CSYNC_INSTRUCTION_CONFLICT));
        GLib.assert_true (itemInstruction (complete_spy, "A/a5" DVSUFFIX, CSYNC_INSTRUCTION_REMOVE));
        ...
        GLib.assert_true (itemInstruction (complete_spy, "A/b4m" DVSUFFIX, CSYNC_INSTRUCTION_NEW));
        ...
        GLib.assert_cmp (dbRecord (fake_folder, "A/a4m").type, ItemTypeFile);
        GLib.assert_cmp (dbRecord (fake_folder, "A/a5").type, ItemTypeFile);
        GLib.assert_cmp (dbRecord (fake_folder, "A/a6").type, ItemTypeFile);
        GLib.assert_cmp (dbRecord (fake_folder, "A/a7").type, ItemTypeFile);
        GLib.assert_cmp (dbRecord (fake_folder, "A/b1").type, ItemTypeFile);
        GLib.assert_true (!dbRecord (fake_folder, "A/b1" DVSUFFIX).is_valid ());
        GLib.assert_cmp (dbRecord (fake_folder, "A/b2").type, ItemTypeFile);
        GLib.assert_true (!dbRecord (fake_folder, "A/b3").is_valid ());
        GLib.assert_cmp (dbRecord (fake_folder, "A/b4m" DVSUFFIX).type, ItemTypeVirtualFile);
        GLib.assert_true (!dbRecord (fake_folder, "A/a1" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "A/a2" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "A/a3" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "A/a4" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "A/a5" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "A/a6" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "A/a7" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "A/b1" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "A/b2" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "A/b3" DVSUFFIX).is_valid ());
        GLib.assert_true (!dbRecord (fake_folder, "A/b4" DVSUFFIX).is_valid ());
    ...
    ***********************************************************/
    private void on_signal_test_virtual_file_download_resume () {
        ...
        GLib.assert_true (fake_folder.current_local_state ().find ("A/a1" DVSUFFIX));
        GLib.assert_true (!fake_folder.current_local_state ().find ("A/a1"));
        GLib.assert_cmp (dbRecord (fake_folder, "A/a1" DVSUFFIX).type, ItemTypeVirtualFileDownload);
    ...
    ***********************************************************/
    private void on_signal_test_rename_to_virtual () {
        ...
        GLib.assert_true (fake_folder.current_remote_state ().find ("A/a1"));
        GLib.assert_true (itemInstruction (complete_spy, "A/a1" DVSUFFIX, CSYNC_INSTRUCTION_SYNC));
        GLib.assert_cmp (dbRecord (fake_folder, "A/a1" DVSUFFIX).type, ItemTypeVirtualFile);
        GLib.assert_true (!dbRecord (fake_folder, "A/a1").is_valid ());
        ...
        GLib.assert_true (itemInstruction (complete_spy, "A/rand", CSYNC_INSTRUCTION_RENAME));
        GLib.assert_true (dbRecord (fake_folder, "A/rand").type == ItemTypeFile);
    ...
    ***********************************************************/
    private void on_signal_test_rename_virtual () {
        ...
        GLib.assert_true (itemInstruction (complete_spy, "renamed1" DVSUFFIX, CSYNC_INSTRUCTION_RENAME));
        GLib.assert_true (dbRecord (fake_folder, "renamed1" DVSUFFIX).is_valid ());
        ...
        GLib.assert_true (itemInstruction (complete_spy, "renamed2" DVSUFFIX, CSYNC_INSTRUCTION_RENAME));
        GLib.assert_true (dbRecord (fake_folder, "renamed2" DVSUFFIX).type == ItemTypeVirtualFile);

        GLib.assert_true (itemInstruction (complete_spy, "file3", CSYNC_INSTRUCTION_SYNC));
        GLib.assert_true (dbRecord (fake_folder, "file3").type == ItemTypeFile);
        on_signal_cleanup ();
    ...
    ***********************************************************/
    private void on_signal_test_rename_virtual2 () {
        ...
        GLib.assert_true (itemInstruction (complete_spy, "case3-rename" DVSUFFIX, CSYNC_INSTRUCTION_RENAME));
        GLib.assert_true (dbRecord (fake_folder, "case3-rename" DVSUFFIX).type == ItemTypeVirtualFile);
        ...
        GLib.assert_true (dbRecord (fake_folder, "case4-rename").type == ItemTypeFile);
        ...
        GLib.assert_true (itemInstruction (complete_spy, "case5-rename" DVSUFFIX, CSYNC_INSTRUCTION_RENAME));
        GLib.assert_true (dbRecord (fake_folder, "case5-rename" DVSUFFIX).type == ItemTypeVirtualFile);
        ...
        GLib.assert_true (itemInstruction (complete_spy, "case6-rename", CSYNC_INSTRUCTION_RENAME));
        GLib.assert_true (dbRecord (fake_folder, "case6-rename").type == ItemTypeFile);
    }
    ...
    private void on_signal_test_sync_dehydration () {
        ...
        GLib.assert_cmp (complete_spy.find_item ("A/a1" DVSUFFIX).renameTarget, "A/a1" + DVSUFFIX);
        GLib.assert_true (isDehydrated ("A/a2"));
        GLib.assert_true (hasDehydratedDbEntries ("A/a2"));
        GLib.assert_true (itemInstruction (complete_spy, "A/a2" DVSUFFIX, CSYNC_INSTRUCTION_SYNC));
        ...
        GLib.assert_true (itemInstruction (complete_spy, "B/b3" DVSUFFIX, CSYNC_INSTRUCTION_NEW));
        ...
        GLib.assert_true (fake_folder.sync_once ());
        GLib.assert_cmp (fake_folder.current_local_state (), expectedLocalState);
    ...
    ***********************************************************/
    ...
    private void on_signal_test_suffix_files_while_local_hydrated () {
        ...
        GLib.assert_true (fake_folder.sync_once ());
        GLib.assert_true (itemInstruction (complete_spy, "A/file1" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        GLib.assert_true (itemInstruction (complete_spy, "A/file2" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        GLib.assert_true (itemInstruction (complete_spy, "A/file3" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        GLib.assert_true (itemInstruction (complete_spy, "A/file3" DVSUFFIX DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        on_signal_cleanup ();
        ...
        GLib.assert_true (fake_folder.sync_once ());
        GLib.assert_true (itemInstruction (complete_spy, "A/test1", CSYNC_INSTRUCTION_NEW));
        ...
        GLib.assert_true (itemInstruction (complete_spy, "A/test2" DVSUFFIX, CSYNC_INSTRUCTION_UPDATE_METADATA));
        on_signal_cleanup ();
        ...
        GLib.assert_true (fake_folder.sync_once ());
        GLib.assert_true (itemInstruction (complete_spy, "A/remote1" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        GLib.assert_true (itemInstruction (complete_spy, "A/remote2" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        GLib.assert_true (itemInstruction (complete_spy, "A/remote3" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        GLib.assert_true (itemInstruction (complete_spy, "A/remote3" DVSUFFIX DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        on_signal_cleanup ();

        // New files with a suffix aren't propagated downwards in the first place
        fake_folder.remote_modifier ().insert ("A/new1" DVSUFFIX);
        GLib.assert_true (fake_folder.sync_once ());
        GLib.assert_true (itemInstruction (complete_spy, "A/new1" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
    ...
    private void on_signal_test_extra_files_local_dehydrated () {
        ...
        GLib.assert_true (itemInstruction (complete_spy, "A/file1" DVSUFFIX, CSYNC_INSTRUCTION_NEW));
        GLib.assert_true (itemInstruction (complete_spy, "A/file2" DVSUFFIX, CSYNC_INSTRUCTION_NEW));
        GLib.assert_true (itemInstruction (complete_spy, "A/file3" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        GLib.assert_true (itemInstruction (complete_spy, "A/file4" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        GLib.assert_true (itemInstruction (complete_spy, "A/file4" DVSUFFIX DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        on_signal_cleanup ();
        ...
        GLib.assert_true (fake_folder.sync_once ());
        GLib.assert_true (itemInstruction (complete_spy, "A/file1", CSYNC_INSTRUCTION_CONFLICT));
        GLib.assert_true (itemInstruction (complete_spy, "A/file1" DVSUFFIX, CSYNC_INSTRUCTION_REMOVE)); // it's now a pointless real virtual file
        GLib.assert_true (itemInstruction (complete_spy, "A/file2" DVSUFFIX DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        GLib.assert_true (itemInstruction (complete_spy, "A/file5" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        GLib.assert_true (itemInstruction (complete_spy, "A/file6", CSYNC_INSTRUCTION_CONFLICT));
        GLib.assert_true (itemInstruction (complete_spy, "A/file6" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        on_signal_cleanup ();
    }
    ...
    ***********************************************************/
    private void on_signal_test_pin_state_locals () {
        ...
        // root is unspecified
        GLib.assert_cmp (*vfs.pinState ("file1" DVSUFFIX), PinState.PinState.UNSPECIFIED);
        ...
        GLib.assert_true (fake_folder.sync_once ());
        GLib.assert_cmp (*vfs.pinState ("onlinerenamed2/file1rename"), PinState.VfsItemAvailability.ONLINE_ONLY);
        GLib.assert_cmp (*vfs.pinState ("onlinerenamed2/file1rename" DVSUFFIX), PinState.VfsItemAvailability.ONLINE_ONLY);

        // When a file is hydrated or dehydrated due to pin state it retains its pin state
        GLib.assert_true (vfs.setPinState ("onlinerenamed2/file1rename" DVSUFFIX, PinState.PinState.ALWAYS_LOCAL));
        GLib.assert_true (fake_folder.sync_once ());
    ...
    ***********************************************************/
    private void on_signal_test_incompatible_pins () {
        ...
        GLib.assert_cmp (*vfs.pinState ("online/file1"), PinState.PinState.UNSPECIFIED);
        GLib.assert_cmp (*vfs.pinState ("local/file1" DVSUFFIX), PinState.PinState.UNSPECIFIED);
    ...
    ***********************************************************/
    private void on_signal_test_place_holder_exist () {
        ...
        GLib.assert_true (fake_folder.sync_once ());
        GLib.assert_cmp (fake_folder.current_local_state (), fake_folder.current_remote_state ());
        GLib.assert_true (itemInstruction (complete_spy, "A/a1" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        GLib.assert_true (itemInstruction (complete_spy, "A/hello" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        ...
        GLib.assert_true (fake_folder.sync_once ());
        GLib.assert_true (itemInstruction (complete_spy, "A/a1" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        GLib.assert_true (itemInstruction (complete_spy, "A/igno" DVSUFFIX, CSYNC_INSTRUCTION_IGNORE));
        ...
        on_signal_cleanup ();
        // Dehydrate
        GLib.assert_true (vfs.setPinState ("", PinState.VfsItemAvailability.ONLINE_ONLY));
        GLib.assert_true (!fake_folder.sync_once ());
