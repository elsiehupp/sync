...
//  #endif
    ...
    ***********************************************************/
    ...
    /***********************************************************
    ***********************************************************/
    public GLib.TlsConfiguration ssl_configuration { public get; public set; }
    ...
    ***********************************************************/
    public GLib.TlsConfiguration get_or_create_ssl_config () {
        ...
        //  GLib.TlsConfiguration ssl_config = GLib.TlsConfiguration.default_configuration ();
    ...
    ***********************************************************/
    public void on_signal_handle_ssl_errors (GLib.InputStream input_stream, GLib.List<GnuTLS.ErrorCode> errors) {
        ...
        //          GLib.TlsConfiguration.default_configuration ().add_ca_certificates (approved_certificates);
