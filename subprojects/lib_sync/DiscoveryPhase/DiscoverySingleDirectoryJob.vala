...
public class DiscoverySingleDirectoryJob { //: GLib.Object {
    ...
    ***********************************************************/
    internal signal void first_directory_permissions (Common.RemotePermissions permissions);
    internal signal void etag (string string_value, GLib.DateTime time);
    ...
    ***********************************************************/
    ...
    /***********************************************************
    ***********************************************************/
    //  private void on_signal_directory_listing_iterated_slot (
    //      string string_value,
