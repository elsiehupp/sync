...
public class Utility { //: GLib.Object {
    ...
    ***********************************************************/
    public static string time_ago_in_words (GLib.DateTime glib_date_time, GLib.DateTime from = new GLib.DateTime ()) {
        ...
        //  if (glib_date_time.days_to (now) == 1) {
        //      return _("%n day ago", "", glib_date_time.days_to (now));
        //  } else if (glib_date_time.days_to (now) > 1) {
        //      return _("%n days ago", "", glib_date_time.days_to (now));
        //  } else {
        //      int64 secs = glib_date_time.secs_to (now);
        //      if (secs < 0) {
    ...
    ***********************************************************/
    public static string make_conflict_filename (
        ...
        //  }
        //  conflict_marker += glib_date_time.to_string ("yyyy-MM-dd hhmmss") + ")";
