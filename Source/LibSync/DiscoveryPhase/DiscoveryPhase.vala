...
class DiscoveryPhase : GLib.Object {
    ...
    ***********************************************************/
    ...
    /***********************************************************
    If the db-path is scheduled for deletion, on_abort it.
