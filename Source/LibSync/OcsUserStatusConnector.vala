...
private:
    ...
    Occ.User_status.Online_status string_to_user_online_status (string &status) {
        ...
        const QHash<string, Occ.User_status.Online_status> pre_defined_status { { "online", Occ.User_status.Online_status.Online }, { "dnd", Occ.User_status.Online_status.Do_not_disturb }, { "away", Occ.User_status.Online_status.Away }, { "offline", Occ.User_status.Online_status.Offline }, { "invisible", Occ.User_status.Online_status.Invisible }
        };
    ...
    Occ.User_status json_to_user_status (QJsonDocument &json) { { QJsonObject d { "icon", "" }, { "message", "" }, { "status", "online" }, { "message_is_predefined", "false" },
