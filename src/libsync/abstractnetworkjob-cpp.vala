...
QUrl AbstractNetworkJob.makeAccountUrl (QString &relativePath) {
    return Utility.concatUrlPath (_account.url (), relativePath);
}

QUrl AbstractNetworkJob.makeDavUrl (QString &relativePath) {
...
QString AbstractNetworkJob.errorString () {
    if (_timedout) {
