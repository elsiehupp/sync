...
QString UserStatusSelectorModel.userStatusMessage () {
...
QString UserStatusSelectorModel.userStatusEmoji () {
...
QString UserStatusSelectorModel.clearAtStageToString (ClearStageType stage) {
    switch (stage) {
    case ClearStageType.DontClear:
...
QString UserStatusSelectorModel.errorMessage () {
    return _errorMessage;
}

QString UserStatusSelectorModel.timeDifferenceToString (int differenceSecs) {
...
QString UserStatusSelectorModel.predefinedStatusClearAt (int index) {
    return clearAtReadable (predefinedStatus (index).clearAt ());
}

QString UserStatusSelectorModel.clearAt () {
